...
function FilterCont() {
    return (
        <div className="flex flex-col gap-4 sticky top-14 z-10 bg-white">
            <div className="w-10/12 m-auto h-20  font-sans flex">
            <div className="flex cursor-pointer  hover:text-red-500 duration-300 flex-col justify-center items-center  ml-24">
            ...
            <div className="flex flex-col cursor-pointer hover:text-red-500 duration-300 justify-center items-center ml-24">
            ...
            <div className="flex cursor-pointer hover:text-red-500 duration-300 gap-5 border-[1px] rounded-2xl h-[40%] mt-4 w-[12%] p-5 justify-center items-center ml-24">
