...
function ProfileFooter() {
    return ( 
        <>
            <div className="w-full h-[18em] bg-stone-50 mt-24 border-[1px] flex gap-20">
            <div className="w-3/12 h-full flex flex-col pl-24 pt-10 gap-5">
                <p> Support</p>
            ...
            <div className="w-3/12 h-full flex flex-col pl-10 pt-10 gap-5">
                <p>Hosting</p>
            ...
            <div className="w-3/12 h-full flex flex-col pt-10 gap-5">
                <p>Airbnb</p>
        ...
        <div className="w-full h-10 border-stone-100 border-[1px] bg-stone-100 flex justify-center items-center">
